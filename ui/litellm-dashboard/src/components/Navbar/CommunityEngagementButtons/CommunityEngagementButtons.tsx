...
export const CommunityEngagementButtons: React.FC = () => {
  ...
  return (
    <div
      ...
      aria-label={t("Community links")}
    >
      <Tooltip title={t("LiteLLM Slack community")}>
        <a
          href="https://www.litellm.ai/support"
          target="_blank"
          rel="noopener noreferrer"
          className={iconBtnClass}
          aria-label={t("Join Slack")}
        >
          <SlackOutlined className="text-lg" />
        </a>
      </Tooltip>
      <Tooltip title={t("LiteLLM on GitHub")}>
        <a
          href="https://github.com/BerriAI/litellm"
          target="_blank"
          rel="noopener noreferrer"
          className={iconBtnClass}
          aria-label={t("LiteLLM on GitHub")}
        >
