          ...
          <>
            <Option value="best_effort_throughput" label={t("Default")}>
              <div style={{ padding: "4px 0" }}>
                ...
                <div style={{ fontSize: "11px", color: "#6b7280", marginTop: "2px" }}>{t("Best effort throughput - no error if we&apos;re overallocating")} {limitTypeLower} (Team/Key Limits
                  checked at runtime).
                </div>
              </div>
            </Option>
            <Option value="guaranteed_throughput" label={t("Guaranteed throughput")}>
              <div style={{ padding: "4px 0" }}>
                ...
                <div style={{ fontSize: "11px", color: "#6b7280", marginTop: "2px" }}>{t("Guaranteed throughput - raise an error if we&apos;re overallocating")} {limitTypeLower} (also checks
            ...
            <Option value="dynamic" label={t("Dynamic")}>
              <div style={{ padding: "4px 0" }}>
                ...
                <div style={{ fontSize: "11px", color: "#6b7280", marginTop: "2px" }}>{t("If the key has a set")} {limitTypeUpper} (e.g. 2 {limitTypeUpper}) and there are no 429 errors, it can
