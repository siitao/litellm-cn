          ...
          <>
                ...
                <Row>
                  ...
                  <Col span={10}>
                    <Text className="mb-5 mt-1">
                      ...
                      <Link href="https://docs.litellm.ai/docs/proxy/health#health" target="_blank">{t("Learn more")}</Link>
                    </Text>
                  </Col>
                </Row>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="space-x-2">
                <Button data-testid="test-connect-btn" onClick={handleTestConnection} loading={isTestingConnection}>{t("Test Connect")}</Button>
                <Button data-testid="add-model-btn" htmlType="submit">{t("Add Model")}</Button>
              </div>
            </div>
          </>
        </Form>
