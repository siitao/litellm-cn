  ...
  return (
    <Dialog open={visible} onOpenChange={(open) => !open && onCancel()}>
      <DialogContent>
        ...
        <div className="py-4">
          <label htmlFor="publish-prompt-name" className="mb-2 block">{t("Name")}</label>
          <Input
            ...
            autoFocus
          />
          <p className="text-muted-foreground text-xs mt-2">{t("Published prompts can be used in API calls and are versioned for easy tracking.")}</p>
        </div>
        <DialogFooter>
