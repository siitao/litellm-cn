    ...
    <div className="a2a-metrics mt-3 pt-2 border-t border-gray-200 text-xs">
      ...
      <div className="flex flex-wrap items-center gap-2 text-gray-500 ml-4">
        ...
        {timeToFirstToken !== undefined && (
          <Tooltip>
            <TooltipTrigger render={<span className="flex items-center text-green-600" />}>{t("TTFT:")} {(timeToFirstToken / 1000).toFixed(2)}s
            </TooltipTrigger>
      ...
      <div className="flex flex-wrap items-center gap-3 text-gray-500 ml-4 mt-1.5">
        ...
        {taskId && (
          <Tooltip>
            ...
            <TooltipContent>{t("Click to copy:")} {taskId}</TooltipContent>
          </Tooltip>
        )}
        ...
        {contextId && (
          <Tooltip>
            ...
            <TooltipContent>{t("Click to copy:")} {contextId}</TooltipContent>
          </Tooltip>
        )}
